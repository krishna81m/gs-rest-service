package com.tracer.util.devtools.filter;

import com.tracer.util.devtools.*;
import com.tracer.util.devtools.helper.RequestTracer;
import com.tracer.util.devtools.helper.TransactionIdUtil;
...
public class HttpLoggingFilter implements Filter {
        ...
        try {
            ...
            if(!ignoreTrace) {
                ...
                while(headerNames.hasMoreElements()) {
                    ...
                    header.setValue(httpServletRequest.getHeader(headerName));

                    httpHeaders.addHeader(header);
                }
                requestEvent.setHttpHeaders(httpHeaders);
            ...
            HttpHeaders httpHeaders = new HttpHeaders();
            Collection<String> headerNames = bufferedResponse.getHeaderNames();
            headerNames.stream().forEach(headerName -> {
                    HttpHeader header = new HttpHeader();
                    header.setName(headerName);
                    header.setValue(bufferedResponse.getHeader(headerName));
            ...
            if(!ignoreTrace) {
                ...
                responseEvent.setHttpHeaders(httpHeaders);
            }

            log.info(logMessage.toString());
        } catch (Throwable a) {
            log.error("REST Request - LOGGING FAILED " + a.getMessage());
        }
    }
    ...
    public class BufferedResponseWrapper implements HttpServletResponse {
        ...
        public String getContent() {
            // temporary check to ignore no output streams
